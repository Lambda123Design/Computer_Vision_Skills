...
Hey everyone! Welcome back. In this lecture, we are going to learn how to train our custom YOLOv7 instance segmentation model. YOLO, which stands for “You Only Look Once,” has multiple versions, and we will focus on YOLOv11 because it is faster in inference and has better accuracy compared to YOLOv12, even though YOLOv12 uses a transformer backbone for feature extraction. YOLOv11 provides enhanced feature extraction, optimized efficiency, speed, and versatility across tasks including classification, detection, and segmentation. Since we are only interested in segmentation, YOLOv11 is ideal for this project.
